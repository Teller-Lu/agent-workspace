...
if (-not $sPaths -or $sPaths.Count -eq 0) {
    [Console]::Error.WriteLine("WARNING: check_s_level.ps1: paths block found in S级清单.md but 0 paths extracted. Check if all paths are commented out.")
    exit 0
}
